...
<p>
   <a href="adminpanel" style="color: darkblue; text-decoration: none;">Home</a>&nbsp; &#8594; &nbsp;<a href="#">Leader</a>
</p>

</div>
    @if(count($team) > 0)

    <div id="wrapper" style="margin-top:30px !important;">
                        ...
                        <div class="col-lg-10 mb-4">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="text-primary fw-bold m-0">LeaderBoard</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    $percentage=($data->score/80)*100;
                                    @endphp


                                    <h4 class="small fw-bold">{{$data->Team_Name}} <span class="float-end">{{$data->score}}
                                        </span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-success" aria-valuenow="20" aria-valuemin="0"
                                            aria-valuemax="100" style="width: {{$percentage}}%"><span
                                                class="visually-hidden">{{$data->score}}</span></div>
                                    </div>
                                    @endforeach
                                </div>
